...
<p>Email: privacy@innoshop.com</p>',
            ...
            [
                ...
                'template' => '',
                'meta_title'       => 'Contact Us - InnoShop',
                'meta_description' => 'Contact InnoShop for support and inquiries',
            ...
            [
                ...
                'locale'   => 'zh-cn',
                'title'    => '联系我们',
                'content'  => '<h1>联系我们</h1><p>如有任何疑问，请联系我们。</p>',
                'template' => '',
                'meta_title'       => '联系我们 - InnoShop',
                'meta_description' => '联系 InnoShop 获取支持和咨询',
                'meta_keywords'    => '联系, 支持, 帮助',
            ],
            [
                'page_id'  => 6,
                'locale'   => 'en',
                'title'    => 'Shipping Info',
                'content'  => '<h1>Shipping Information</h1><p>Learn about our shipping policies and delivery times.</p>',
                'template' => '',
                'meta_title'       => 'Shipping Info - InnoShop',
                'meta_description' => 'Shipping information and delivery details',
                'meta_keywords'    => 'Shipping, Delivery, Info',
            ],
            [
                'page_id'  => 6,
                'locale'   => 'zh-cn',
                'title'    => '配送信息',
                'content'  => '<h1>配送信息</h1><p>了解我们的配送政策和送货时间。</p>',
                'template' => '',
                'meta_title'       => '配送信息 - InnoShop',
                'meta_description' => '配送信息和送货详情',
                'meta_keywords'    => '配送, 送货, 信息',
            ],
        ];
    }
}
