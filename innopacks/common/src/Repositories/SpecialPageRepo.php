...
class SpecialPageRepo
{
    ...
    public function getOptions(): array
    {
        $specialOptions = [
            ...
            ['type' => 'contact', 'title' => trans('front/common.contact'), 'route' => 'pages.slug_show'],
            ['type' => 'shipping', 'title' => trans('front/common.shipping'), 'route' => 'pages.slug_show'],
        ];
    ...
    public function getSpecialLinks($specials): array
    {
        ...
        foreach ($specials as $special) {
            ...
            } elseif ($special == 'contact') {
                $url = front_route('pages.slug_show', ['slug' => 'contact']);
            } elseif ($special == 'shipping') {
                $url = front_route('pages.slug_show', ['slug' => 'shipping-info']);
            } else {
                continue;
            }
            $items[] = [
